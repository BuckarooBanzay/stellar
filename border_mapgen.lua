local c_border = minetest.get_content_id("stellar:border")

function stellar.is_border_mapblock(mapblock_pos, pod_pos)
...
function stellar.draw_border(data, area, _, _, minp, maxp)
